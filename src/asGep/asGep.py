...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def create_connections(self):
        ...
        self.ui.refreshLoadButton.clicked.connect(
            self.loadRefreshData)  # refresh entity data (preset + selection) on load tab
    ...
    def exportXML(self):
        ...
        fileIn = QtWidgets.QFileDialog.getSaveFileName(self, 'Save Entity Preset File', getPath(),
                                                       'Golaem Entity Preset files (*.gepml)')
    ...
    def loadPresetFolder(self):
        ...
        folderPath = QtWidgets.QFileDialog.getExistingDirectory(self, 'Set Entity Preset Folder', getPath(),
    ...
    def loadLayoutFile(self):
        layoutFile = QtWidgets.QFileDialog.getOpenFileName(self, 'Set Layout Editor File', getPath(),
                                                           'Golaem Layout files (*.gscl)')
    ...
    def createLayoutNode(self):
        ...
        if (fileHandle is not None):
            ...
            if self.ui.meshesCheckBox.isChecked() == True:
                ...
                selMeshesAssets = cmds.glmLayoutTool(cacheProxy=nodeName, getAvailableMeshAssets=True,
                                                     requestSourceNode=rootId)
    ...
    def sdItemDoubleClicked(self, list):
        ...
        if layoutEWrapper is not None:
            ...
            layoutEWrapper.addOrEditLayoutTransformation('{} {}'.format(nodeName, layoutIndex), '{}'.format(entityId),
                                                         'SetShaderAttribute', 'shaderAttribute', ['{}'.format(list)],
                                                         None, 0)
